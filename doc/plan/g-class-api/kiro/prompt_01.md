...
Open Classroom → Shows course list
Click a course → Shows that course's assignments/notifications
You want:

Open Classroom → Shows ALL assignments from ALL courses (with toggle to switch to ALL notifications)
...
Open Classroom → Shows list of courses
Click a course → Shows that course's assignments/notifications
Toggle between To-Do and Notices for that single course
After:

Open Classroom → Shows ALL assignments from ALL enrolled courses together
...
✅ Included: Active, enrolled courses
❌ Excluded: Archived courses
❌ Excluded: Deleted courses
❌ Excluded: Declined courses
...
The implementation is correct and should only show your active, enrolled courses. No changes needed! 🎉
...
The implementation now properly excludes archived courses and old assignments/announcements! 🎉