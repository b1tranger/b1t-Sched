...
- [ ] 1. Set up Firebase Cloud Functions infrastructure
...
- [ ] 2. Implement backend API endpoints
  - [ ] 2.1 Create password reset endpoint
  ...
  - [ ] 2.3 Create user deletion endpoint
...
- [ ] 3. Deploy and test backend endpoints
...
- [ ] 4. Create frontend API client
  - [ ] 4.1 Implement AdminAPI class in `js/admin-api.js`
...
- [ ] 5. Implement Filter Popup component
  - [ ] 5.1 Create filter popup HTML structure
  ...
  - [ ] 5.2 Add filter popup CSS styling
  ...
  - [ ] 5.3 Implement FilterPopup JavaScript class
  ...
  - [ ] 5.4 Wire up filter popup event listeners
...
- [ ] 7. Implement action button optimizations
  - [ ] 7.1 Update action button CSS for consistent sizing
  ...
  - [ ] 7.2 Update user card actions layout
...
- [ ] 8. Add password reset and delete buttons to user cards
  - [ ] 8.1 Update renderUserList() to include new buttons
...
- [ ] 9. Implement delete user confirmation dialog
  - [ ] 9.1 Create confirmation dialog HTML
...
- [ ] 10. Wire up password reset functionality
  - [ ] 10.1 Add event listener for password reset buttons
  ...
  - [ ] 10.2 Add success and error notifications
...
- [ ] 11. Wire up user deletion functionality
  - [ ] 11.1 Add event listener for delete user buttons
    - Use event delegation on user list container
  ...
  - [ ] 11.2 Add confirmation dialog event listeners
  ...
  - [ ] 11.3 Implement user deletion logic
...
- [ ] 13. Add admin logs collection initialization
...
- [ ] 14. Final integration and testing
  - [ ] 14.1 Test complete password reset flow
  ...
  - [ ] 14.2 Test complete user deletion flow
  ...
  - [ ] 14.3 Test filter popup on all devices
  ...
  - [ ] 14.4 Test action button consistency
